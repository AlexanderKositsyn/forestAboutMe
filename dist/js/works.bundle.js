...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__js_modules_animation_textShowAnimationVue__ = __webpack_require__(99);
//
//
//
//
...
function nextSlideTopSlider(nextItem) {
  ...
  if ([...document.querySelectorAll(".my-works__slider-item")].length !== 0) {
    ...
    document.querySelectorAll(".my-works__slider-item")[nextItem].classList.add("active");
  }
}
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    previousButtonClicked() {
      this.currentItem == 0 ? this.currentItem = this.$store.state.sliderData.length - 1 : --this.currentItem;
      nextSlideTopSlider(this.currentItem); //   console.log("currentItem" + this.currentItem);
    },

    nextButtonClicked() {
      this.currentItem == this.$store.state.sliderData.length - 1 ? this.currentItem = 0 : ++this.currentItem;
  ...
  computed: {
    ...
    slideTechnogies() {
      if (this.$store.state.sliderData.length !== 0) {
        return this.$store.state.sliderData[this.descriptionNumber].siteTechnogies;
      }
    },
    ...
    descriptionNumber() {
      return this.currentItem; //   console.log("descriptionNumber" + this.currentItem);
    },

    // основной слайдер
    sliderTop() {
      document.querySelectorAll(".my-works__slider-item")[currentItem].classList.add(".my-works__slider-item--active");
    },
  ...
  watch: {
    slideName() {
      ...
      Object(__WEBPACK_IMPORTED_MODULE_1__js_modules_animation_textShowAnimationVue__["a" /* default */])(siteName, 0, this.slideName);
    },

    slideTechnogies() {
      let siteTechnogies;
      siteTechnogies = this.$el.querySelector(".my-works__site-technogies");
      Object(__WEBPACK_IMPORTED_MODULE_1__js_modules_animation_textShowAnimationVue__["a" /* default */])(siteTechnogies, 0, this.slideTechnogies);
    }
  ...
  created() {
    ...
    __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get("/api/works").then(function (response) {
      console.log("from /api/works response");
      console.log(response.data.sliderItems); // когда придет ответ запишем в store

      store.commit("setSliderData", response.data.sliderItems);
    }).then(nextSlideTopSlider(this.currentItem)).catch(function (error) {
      console.log(error);
    });
  },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__img_feeds_avatar1_png__ = __webpack_require__(91);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__img_feeds_avatar1_png___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__img_feeds_avatar1_png__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__img_feeds_avatar2_png__ = __webpack_require__(92);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__img_feeds_avatar2_png___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__img_feeds_avatar2_png__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__img_site1_jpg__ = __webpack_require__(93);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__img_site1_jpg___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__img_site1_jpg__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__img_site2_jpg__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__img_site2_jpg___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__img_site2_jpg__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__img_site3_jpg__ = __webpack_require__(95);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__img_site3_jpg___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__img_site3_jpg__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_normalize_css__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__sass_base_scss__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__sass_base_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8__sass_base_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__node_modules_svg4everybody_dist_svg4everybody__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__node_modules_svg4everybody_dist_svg4everybody___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9__node_modules_svg4everybody_dist_svg4everybody__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_vue__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__vue_slider_slider_vue__ = __webpack_require__(96);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__store_store__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__js_modules_hamburger__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__js_modules_blur__ = __webpack_require__(101);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__js_modules_animation_scrollIt__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__js_modules_preloader__ = __webpack_require__(18);
/*---images---*/
...
__WEBPACK_IMPORTED_MODULE_9__node_modules_svg4everybody_dist_svg4everybody___default()();
/*---vue components---*/
...
document.addEventListener("DOMContentLoaded", function (event) {
  Object(__WEBPACK_IMPORTED_MODULE_16__js_modules_preloader__["a" /* default */])(["images/water.jpg"]); // устанавливаем обработчик для стрелки

  document.querySelector(".bottom-arrow").addEventListener("click", () => {
    Object(__WEBPACK_IMPORTED_MODULE_15__js_modules_animation_scrollIt__["a" /* default */])(document.querySelector(".main"), 500, "easeOutQuad");
  });
  document.querySelector(".arrow-top").addEventListener("click", () => {
    Object(__WEBPACK_IMPORTED_MODULE_15__js_modules_animation_scrollIt__["a" /* default */])(document.querySelector(".wrapper"), 500, "easeOutQuad");
  });
  Object(__WEBPACK_IMPORTED_MODULE_13__js_modules_hamburger__["a" /* default */])();

  window.onload = () => {
    Object(__WEBPACK_IMPORTED_MODULE_14__js_modules_blur__["a" /* default */])();
  }; //вызываем модуль vue для слайдера


  window.vm = new __WEBPACK_IMPORTED_MODULE_10_vue__["a" /* default */]({
    el: "slider",
    store: __WEBPACK_IMPORTED_MODULE_12__store_store__["a" /* default */],
    render: h => h(__WEBPACK_IMPORTED_MODULE_11__vue_slider_slider_vue__["a" /* default */])
  });
});
...
module.exports = __webpack_require__.p + "images/site1.jpg";

/***/ }),
/* 94 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "images/site2.jpg";

/***/ }),
/* 95 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "images/site3.jpg";
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_slider_vue__ = __webpack_require__(55);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_11b898d3_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_template_compiler_preprocessor_engine_pug_node_modules_vue_loader_lib_selector_type_template_index_0_slider_vue__ = __webpack_require__(100);
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_11b898d3_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_template_compiler_preprocessor_engine_pug_node_modules_vue_loader_lib_selector_type_template_index_0_slider_vue__["a" /* default */],
...
var update = __webpack_require__(4)("43d2ce39", content, true);
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = animate_Text;
function animate_Text(elem, delay, text) {
  elem.parentElement.style.display = "none";
  setTimeout(() => {
    //найдем текс внутри элемента
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"my-works",attrs:{"id":"slider"}},[_c('div',{staticClass:"my-works__slider"},[_c('div',{staticClass:"my-works__slider-wrapper"},[_c('ul',{staticClass:"my-works__slider-list"},_vm._l((_vm.sliderData),function(item){return _c('li',{staticClass:"my-works__slider-item",class:{ active: item.active }},[_c('img',{staticClass:"my-works__slider-img",attrs:{"src":_vm.getImgUrl(item.imgSrc)}})])}))])]),_c('div',{staticClass:"my-works__decription"},[_c('div',{staticClass:"my-works__decription-wrapper"},[_c('div',{staticClass:"my-works__site-name"},[_vm._v(_vm._s(_vm.slideName))]),_c('div',{staticClass:"my-works__site-technogies"},[_vm._v(_vm._s(_vm.slideTechnogies))]),_c('a',{staticClass:"my-works__site-link",attrs:{"href":_vm.slideLink}},[_c('svg',{staticClass:"my-works__svg-link"},[_c('use',{attrs:{"xlink:href":"./images/sprite.svg#link"}})]),_vm._v("Посмотреть сайт   ")])])]),_c('div',{staticClass:"my-works__slider-buttons"},[_c('a',{staticClass:"my-works__button-previous",attrs:{"href":"#"},on:{"click":function($event){$event.preventDefault();_vm.previousButtonClicked($event)}}},[_c('ul',{staticClass:"my-works__previous-list",style:({ bottom: _vm.sliderPrevious })},_vm._l((_vm.sliderData),function(item){return _c('li',{staticClass:"my-works__previous-item"},[_c('img',{staticClass:"my-works__previous-img",attrs:{"src":_vm.getImgUrl(item.imgSrc)}})])})),_c('svg',{staticClass:"my-works__arrow-down my-works__arrow-down--portf_arrow_down"},[_c('use',{attrs:{"xlink:href":"./images/sprite.svg#portf_arrow_down"}})])]),_c('a',{staticClass:"my-works__button-next",attrs:{"href":"#"},on:{"click":function($event){$event.preventDefault();_vm.nextButtonClicked($event)}}},[_c('ul',{staticClass:"my-works__next-list",style:({ top: _vm.sliderNext })},_vm._l((_vm.sliderData),function(item){return _c('li',{staticClass:"my-works__next-item"},[_c('img',{staticClass:"my-works__next-img",attrs:{"src":_vm.getImgUrl(item.imgSrc)}})])})),_c('svg',{staticClass:"my-works__arrow-up my-works__arrow-up--portf_arrow_up"},[_c('use',{attrs:{"xlink:href":"./images/sprite.svg#portf_arrow_up"}})])])])])}
var staticRenderFns = []
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = initBlur;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__helpFunctions_pageY__ = __webpack_require__(50);

function initBlur() {
  let set = () => {
    let bgOuter = document.querySelector(".wrapper--works"),
        bgInner = document.querySelector(".callback-form__blur"),
        bgInnerStyles = bgInner.style; // определение высоты всего документа

    let body = document.body,
        html = document.documentElement;
    let documentHeight = Math.max(body.scrollHeight, body.offsetHeight, html.clientHeight, html.scrollHeight, html.offsetHeight); // найдем необходимые св ва
    ...
    bottomBgInner = -(documentHeight - (Object(__WEBPACK_IMPORTED_MODULE_0__helpFunctions_pageY__["a" /* default */])(bgInner) + bgInner.offsetHeight)); // применяем св ва
  ...
  set(); //  если страница меняется в размере то вызываем ее опять чтобы изменить бэкграунд
